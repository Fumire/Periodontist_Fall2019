...
def get_feature_importances(file_name, level=6, percentile=5):
    """
    get feature importances
    last modified: 2019-08-29T13:45:54+0900
    """
    _pickle_file = "pickles/feature_importances_" + file_name + "_" + str(level) + "_" + str(percentile) + ".pkl"
    ...
    return_data = return_data[:len(return_data) * percentile // 100]
