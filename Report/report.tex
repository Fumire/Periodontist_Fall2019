...
\begin{document}
    ...
    \section{Methods}
    	...
    	\subsection{Stages of Periodontitis}
    		There are five clinical stages of periodontitis as table \ref{tb:stage}.
    		
			\begin{table}[htpb]
				\centering
				\caption{Clinical Stages of Periodontitis}
				\label{tb:stage}
				\begin{tabular}{cc}
					Kinds & Stages \\ \hline \hline
					Healthy & Healthy \\ \hline
					\multirow{3}{*}{Chronic} & Slight \\
					& Moderate \\
					& Severe \\ \hline
					Acute & Acute
				\end{tabular}
